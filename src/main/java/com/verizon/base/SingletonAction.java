...
import com.verizon.exception.AutomationException;
import com.verizon.utilities.ExtentReport;
...
Logger logger = LogManager.getLogger(SingletonAction.class);
	...
	public static WebDriver getActiveWebDriver() {
		return getWebDriver(getProperties().getProperty("browser"));
	}
